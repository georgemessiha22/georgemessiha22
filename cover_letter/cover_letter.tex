...
A copy of my \httplink[Summarized resume]{github.com/georgesamir22/resume/blob/master/George_Messiha_Resume.pdf} attached, 
(\httplink[detailed resume]{github.com/georgesamir22/resume/blob/master/George_Messiha_detailed_resume.pdf}) 
